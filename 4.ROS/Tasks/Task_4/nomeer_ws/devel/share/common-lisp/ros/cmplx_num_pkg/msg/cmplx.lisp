...
(cl:in-package cmplx_num_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <cmplx>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cmplx)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cmplx_num_pkg-msg:<cmplx> is deprecated: use cmplx_num_pkg-msg:cmplx instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <cmplx>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cmplx_num_pkg-msg:real-val is deprecated.  Use cmplx_num_pkg-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginary-val :lambda-list '(m))
(cl:defmethod imaginary-val ((m <cmplx>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cmplx_num_pkg-msg:imaginary-val is deprecated.  Use cmplx_num_pkg-msg:imaginary instead.")
  (imaginary m))
