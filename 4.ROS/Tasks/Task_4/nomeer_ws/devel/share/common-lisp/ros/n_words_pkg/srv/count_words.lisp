...
(cl:defmethod cl:initialize-instance :after ((m <count_words-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'count_words-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n_words_pkg-srv:<count_words-request> is deprecated: use n_words_pkg-srv:count_words-request instead.")))

(cl:ensure-generic-function 'words-val :lambda-list '(m))
(cl:defmethod words-val ((m <count_words-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n_words_pkg-srv:words-val is deprecated.  Use n_words_pkg-srv:words instead.")
  (words m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<count_words-request>)))
  ...
  "n_words_pkg/count_wordsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'count_words-request)))
  "Returns string type for a service object of type 'count_words-request"
  "n_words_pkg/count_wordsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <count_words-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'count_words-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n_words_pkg-srv:<count_words-response> is deprecated: use n_words_pkg-srv:count_words-response instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <count_words-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n_words_pkg-srv:count-val is deprecated.  Use n_words_pkg-srv:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<count_words-response>)))
  ...
  "n_words_pkg/count_wordsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'count_words-response)))
  "Returns string type for a service object of type 'count_words-response"
  "n_words_pkg/count_wordsResponse")
