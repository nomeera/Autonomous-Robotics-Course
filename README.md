...
* [nomeer_ws](4.ROS/Tasks/Task_4/nomeer_ws)
  ...
  * a service that can count the number of words, ex: i love you >> 3, you are the best >> 4.[![](https://img.shields.io/badge/-help%20wanted-critical.svg)](https://github.com/nomeera/Autonomous-Robotics-Course/tree/master/4.ROS/Tasks/Task_4/nomeer_ws/src/n_words_pkg) << click on it
